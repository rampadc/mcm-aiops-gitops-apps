...
ENC_AWS_ID=$(echo -n ${AWS_ID} | kubeseal --raw --name=$VALUES_cluster-aws-creds --namespace=$VALUES_cluster --controller-namespace $SEALED_SECRET_NAMESPACE --controller-name $SEALED_SECRET_CONTROLLER_NAME --from-file=/dev/stdin)
ENC_AWS_KEY=$(echo -n ${AWS_KEY} | kubeseal --raw --name=$VALUES_cluster-aws-creds --namespace=$VALUES_cluster --controller-namespace $SEALED_SECRET_NAMESPACE --controller-name $SEALED_SECRET_CONTROLLER_NAME  --from-file=/dev/stdin)
